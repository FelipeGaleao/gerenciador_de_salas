...
export function TableSort({ data }) {
  ...
  const rows = sortedData.map((row) => (
    <tr key={row.id}>
      ...
      <td>{row.lotacao_faculdade}</td>
      <td>{row.curso}</td>
      <td>{row.periodo}</td>
      <td>{row.qtde_alunos_matriculados}</td>
      ...
      <td>
        <Grid grow>
          ...
          <Grid.Col>
            <Button size="xs" color="red" onClick={(e) => { handleDeleteCourse(row.id) }}>
              Excluir
            </Button>
          </Grid.Col>
        </Grid>
      ...
      >
        <thead>
          <tr>
            ...
            <Th
              sorted={sortBy === 'teacher_id'}
              reversed={reverseSortDirection}
              onSort={() => setSorting('teacher_id')}
            >
              Teacher id
            </Th>
            <Th
              sorted={sortBy === 'lotacao_faculdade'}
              reversed={reverseSortDirection}
              onSort={() => setSorting('lotacao_faculdade')}
            >
              Faculdade
            </Th>
            <Th
            ...
            <Th
              sorted={sortBy === 'qtde_alunos_matriculados'}
              reversed={reverseSortDirection}
              onSort={() => setSorting('qtde_alunos_matriculados')}
            >
              Qtde. alunos matriculados
            </Th>
            <Th
